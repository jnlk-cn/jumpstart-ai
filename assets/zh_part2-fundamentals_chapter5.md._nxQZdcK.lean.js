import{c as p,Q as l,j as t,m as a,g as s,n as i}from"./chunks/framework.DpF7k2f3.js";const c=JSON.parse('{"title":"第5章 大模型调用与Prompt工程（深度重写版）","description":"","frontmatter":{"outline":[2,3]},"headers":[],"relativePath":"zh/part2-fundamentals/chapter5.md","filePath":"zh/part2-fundamentals/chapter5.md","lastUpdated":1779672565000}'),h={name:"zh/part2-fundamentals/chapter5.md"};function e(k,n,r,E,d,g){return l(),t("div",null,[...n[0]||(n[0]=[a("",342),s("ul",null,[s("li",{"analysis.get(contract_type,":"","未知)":""},[s("strong",null,"合同类型"),i("：")]),s("li",null,[s("strong",null,"甲方"),i("：{analysis.get('parties',")]),s("li",null,[s("strong",null,"乙方"),i("：{analysis.get('parties',")]),s("li",null,[s("strong",null,"风险评分"),i("：{analysis.get('overall_score', 'N/A')}/10")])],-1),a("",18),s("p",{context:""},null,-1),a("",8),s("p",{diff:"",or:"",无:""},null,-1),s("p",null,"请重点审查：",-1),s("ol",null,[s("li",null,"变更是否引入了新问题"),s("li",null,"变更是否符合代码规范"),s("li",null,"变更是否有更好的实现方式")],-1),s("p",null,'返回JSON格式： """',-1),s("pre",null,[s("code",null,`    response = self.client.chat.completions.create(
        model="gpt-4.1-mini",
        messages=[
